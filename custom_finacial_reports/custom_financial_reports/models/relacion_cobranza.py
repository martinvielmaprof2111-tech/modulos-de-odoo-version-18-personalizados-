...
# Lista global de diarios permitidos para ventas/cobranzas
ALLOWED_JOURNALS = [
...
class ReportRelacionCobranza(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for pay in payments:
            ...
            # FILTRO POR DIARIOS AUTORIZADOS DE LAS FACTURAS COBRADAS
            if invoices and not any(inv.journal_id.name in ALLOWED_JOURNALS for inv in invoices):
                continue
        ...
        for rec in reconciles:
            ...
            # FILTRO POR DIARIO EN CONCILIACIONES PARCIALES
            if inv_move and inv_move.journal_id.name not in ALLOWED_JOURNALS:
                continue
